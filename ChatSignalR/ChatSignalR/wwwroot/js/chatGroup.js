...
connection.on("ReceiveMessage", function (message) {
    ...
    var li = document.createElement("li");
    li.textContent = message;
    document.getElementById("messagesListPrivate").appendChild(li);
});
...
document.getElementById("privatemsg").addEventListener("click", async (event) => {
    var message = document.getElementById("private-message-text").value;
